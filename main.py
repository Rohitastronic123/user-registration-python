...
heading = Label(root, text="Student Registration", font='Verdana 20 bold')
...
field = StringVar(root, value="STUDENT")
...
vare = Button(root, text="Clear", font='Verdana 10 bold')
vare.place(x=280, y=488)
